...
public class TestA1BasicUIX061 extends ViewTest {
    ...
    private void checkCompletion() throws NullPointerException, ClassCastException {
        ...
        elements.add(com.google.android.material.checkbox.MaterialCheckBox.class); //Element 1
        elements.add(com.google.android.material.checkbox.MaterialCheckBox.class);  //Element 2
        /************************/
